...
and the number of unused words is found bu counting the zeros in the
...
wordlist2 = sorted(zip(words.itervalues(), words.iterkeys()))
max_times, max_word = wordlist2[-1]

# Calculate the percentage of dictionary words used in the book.
unused_words = words.values().count(0) # number of words with a zero count
